...
export default function AlbumDetailScreen() {
  ...
  const handleRemoveFromAlbum = (songId: string) => {
    ...
    Alert.alert(
      'Remove Song',
      'Remove this song from the album?',
      [
...
const styles = StyleSheet.create({
  ...
  songCount: { color: Colors.textSecondary, fontSize: 14, marginTop: 4 },
  playAllButton: {
  ...
  playAllText: { color: Colors.background, fontSize: 16, fontWeight: '600' },
  actions: { paddingHorizontal: 16, paddingBottom: 8 },
  actionButton: { paddingVertical: 8 },
  actionText: { color: Colors.primary, fontSize: 16 },
  removeButton: {
    paddingHorizontal: 16,
    paddingBottom: 8,
    alignItems: 'flex-end',
  },
  removeText: { color: Colors.error, fontSize: 12 },
